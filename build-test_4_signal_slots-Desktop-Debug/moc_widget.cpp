...
#include "../test_4_signal_slots/widget.h"
...
QT_MOC_LITERAL(1, 7, 15), // "sig_textChanged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "str"
QT_MOC_LITERAL(4, 28, 17), // "slot_valueChanged"
QT_MOC_LITERAL(5, 46, 3), // "val"
QT_MOC_LITERAL(6, 50, 16) // "slot_textChanged"

    },
    "Widget\0sig_textChanged\0\0str\0"
    "slot_valueChanged\0val\0slot_textChanged"
};
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Widget::sig_textChanged)) {
                *result = 0;
                return;
            }
        }
