...
QT_MOC_LITERAL(1, 9, 13), // "sig_threadMsg"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "MyThread\0sig_threadMsg\0"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_threadMsg((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::sig_threadMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::sig_threadMsg(const QString & _t1)
{
